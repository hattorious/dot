...
" Make the last yank available to the system clipboard
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
map <leader>e :e! ~/.vimrc.local.vim<cr>
autocmd! bufwritepost .vimrc.local.vim source ~/.vimrc.local.vim
